...
import { PropsTypes } from './PropsTypes.ts';

import Indicator from './Indicator';
import { styles } from './style.ts';

import icon_close_modal from '@/assets/images/imageSlider/icon_close_modal.png';
import { HOST } from '@/utils/const.ts';
          ...
          renderItem={({ item, index }) => {
            return (
              ...
              >
                <Image
                  // @ts-ignore
                  source={localImg ? item.img : { uri: `${HOST}${item.img}` }}
